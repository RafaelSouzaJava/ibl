...
@Entity
public class ClienteCombo implements Serializable {
	...
	public ClienteCombo(Integer id, String nome, String rg, String cpfOuCnpj, Date dataNascimento,
			 String email,Logradouro logradouro, TipoCliente tipo, FormaPagamento formaPagamento,Vencimento vencimento, Combo combos) {
		super();
		this.id = id;
		this.nome = nome;
		this.rg = rg;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ClienteCombo other = (ClienteCombo) obj;
		if (id == null) {
			if (other.id != null)
				return false;
